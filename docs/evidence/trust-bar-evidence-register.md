...
## Group A — "Founder executive track record"
...
| # | Organisation | Evidence source | Status |
|---|---|---|---|
| 1 | ColosseoEAS | Existing site (turnaround case) | Pre-existing (live) |
| 2 | PRANGL | Existing site | Pre-existing (live) |
| 3 | K CERO Invest | Existing site (€200M+ advisory case) | Pre-existing (live) |
| 4 | BKS Bank | Existing site (Čerešňová Alej financing case) — **kept in DBS-era group per Decision 2, not reclassified** | Pre-existing (live) |
